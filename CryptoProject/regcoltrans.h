...
#ifndef _regcoltrans_H
#define _regcoltrans_H
...
public:
  ...
  regcoltrans(std:: string key, std:: string content, bool _enc, bool _dec, bool _tab, int block);
...
regcoltrans:: regcoltrans(std:: string key, std:: string content, bool _enc, bool _dec, bool _tab, int block)
...
std:: string regcoltrans:: return_result()
{
  return final_result;
}
void regcoltrans:: encrypt(std:: string key, std:: string content, bool _tab)
{
    final_result = "";
...
void regcoltrans:: decrypt(std:: string key, std:: string content, bool _tab)
{
    final_result = "";
  int key_length = key.length();
  int content_length = content.length();
...
std:: string regcoltrans:: key_converter(std:: string key)
{
  std:: string numKey = "";
